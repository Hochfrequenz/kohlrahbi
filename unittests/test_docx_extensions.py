...
class TestDocxExtensions:
    @pytest.fixture
    def create_docx_from_filename(self, request: SubRequest, datafiles: Path) -> Generator[DocumentClass, None, None]:
    ...
    def test_get_all_paragraphs_and_tables(
        self, create_docx_from_filename: DocumentClass, expected_length: int
    ) -> None:
    ...
    def test_filter_lastest_version(self, all_file_paths: list[Path], filtered_file_paths: list[Path]) -> None:
